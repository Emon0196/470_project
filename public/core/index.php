				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-12 col-md-6 ">
							<h6 class="text-white ">GariLagbe?Car Rentals Agency.</h6>
							<h1 class="text-white text-uppercase">
								The Royal Essence of Journey
							</h1>
							<p class="pt-20 pb-20 text-white">
									Welcome to GariLagbe? Car Rentals Agency, Search, hire, drive your dream car and travel hassle-free.
							</p>
					...
					<div class="row">
						<div class="col-lg-4 col-md-6">
							<div class="single-feature">
								...
								<p>
									Renting cars is our main job here at GariLagbe? Car Rentals Agency and we have perfected our skills over the years which makes our clients fully satisfied for we have solved their travel mystery.
								</p>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
				...
				<div class="container-fluid">				
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-lg-6 no-padding home-about-right">
							<h1>GariLagbe? Car Rentals Agency<br>
							</h1>
							<p>
							...
							<p>
								...
								Worry no more because here at GariLagbe Car Rentals Agency we take away that dillemma and let you drive your dream car for a couple of days,
					...
					<div class="row">
						<div class="col-lg-4 col-md-6">
							<div class="single-review">
								<h4>Khorshed.</h4>
								<p>
									Our team when its travelling to countryside or around the town we always hire cars from GariLagbe? Rentals Agency and they do not fail us.
