<?php
  ...
  //register staff
		...
		if(isset($_POST['book_car']))
		{
            ...
            $query="INSERT INTO bookings (c_id, cc_id, car_id, car_name, car_type, car_regno, b_duration, c_name, c_natidno, c_phone, b_number, car_price) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            if($stmt)
            {
                     echo $success = "Car Hiring Request Submitted";
                      
                      //echo "<script>toastr.success('Have Fun')</script>";
            }
            else {
              echo $err = "Please Try Again Or Try Later";
            }
