<?php
  ...
  //register staff
		...
		if(isset($_POST['pay_hire']))
		{
            ...
            $query1="INSERT INTO payments (c_id, car_cat_id, car_id, car_name, car_type, car_regno, b_duration, c_name, c_natidno, p_method, p_code, p_amt, p_ref_number) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
            $query2="UPDATE bookings SET b_payment = ? WHERE b_id =?";
                ...
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">Total Price(TK) </label>
                                <?php
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <small>Enter the 11 digit payment code if you used Bkash or Nagad| Bank Slip number if you used bank deposit</small>
