...
<?php
    ...
    if(isset($_POST['login']))
    {
        ...
        $stmt=$mysqli->prepare("SELECT c_email ,c_pwd , c_id FROM clients  WHERE c_email=? AND c_pwd=? ");//sql to log in user
      ...
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          ...
          <div class="col-4">
            ...
            <div class="col-4">
              <a href="client_change_pwd.php" class=" btn btn-outline-danger"><small>Forgot Password?</small></a>
            </div>
