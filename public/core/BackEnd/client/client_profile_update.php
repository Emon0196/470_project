<?php
  ...
  //register staff
        ...
        if(isset($_POST['update_my_profile']))
        {
            ...
            $query="UPDATE clients SET   c_name=?, c_natidno=?, c_phone=?, c_dob=?, c_adr=?, c_email=?, c_dpic=? WHERE c_id =?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('sssssssi', $c_name, $c_natidno, $c_phone, $c_dob, $c_adr, $c_email, $c_dpic, $c_id);
            $stmt->execute();
    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row">
            <div class="card col-md-12">
                <h2 class="card-header">Update <?php echo $row->c_name;?>'s  Account</h2>
                <div class="card-body">
                    <!--Form-->
                    <form method="post" enctype="multipart/form-data" >
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" value="<?php echo $row->c_dob;?>" required name="c_dob" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" required value="<?php echo $row->c_phone;?>" name="c_phone" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" value="<?php echo $row->c_email;?>" required name="c_email"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <button type="submit" name="update_my_profile" class="btn btn-outline-primary">Update My Profile</button>
                    </form>
                    <!-- ./ Form -->
                </div>    
            </div>
