...
<?php
    ...
    if(isset($_POST['login']))
    {
        ...
        $stmt=$mysqli->prepare("SELECT a_email ,a_pwd , a_id FROM admins WHERE a_email=? AND a_pwd=? ");//sql to log in user
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Please provide your email and passsword inorder to access administrator panel.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container mt--8 pb-5">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
              ...
              <form method = "post" role="form">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" required name="a_email" placeholder="Email" type="email">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" required name="a_pwd" placeholder="Password" type="password">
                  </div>
                </div>
          ...
          <div class="row mt-3">
          <div class="col-4">
              <a href="admin_register.php" class=" btn btn-outline-success "><small>Sign Up</small></a>
          </div>

          <div class="row mt-3">
            <div class="col-6">
              <a href="admin_change_pwd.php" class="btn btn-outline-danger"><small>Forgot password?</small></a>
            </div>
