...
<?php
	...
	include('inc/config.php');
      ...
      $query="INSERT INTO admins (a_name, a_number, a_email, a_pwd) values(?,?,?,?)";
      $stmt = $mysqli->prepare($query);
      $rc=$stmt->bind_param('ssss', $a_name, $a_number, $a_email, $a_pwd);
      $stmt->execute();
        ...
        <div class="col-lg-6 col-md-8">
              ...
              <form method = "post" role="form">
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input class="form-control" name="a_name" placeholder="Name" type="text">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input class="form-control" name="a_email" placeholder="Email" type="email">
                  </div>
                </div>
                  ...
                  <div class="input-group input-group-alternative mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="ni ni-email-83"></i></span>
                        ...
                        ?>
                    <input class="form-control" name="a_number" value="<?php echo $admin_number;?>" placeholder="Number" type="text">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="a_pwd" placeholder="Password" type="password">
                  </div>
                </div>
                <div class="row my-4">
                  <div class="col-12">
          ...
          <div class="row mt-3">
            ...
            <div class="col-6 text-right">
              <a href="admin_login.php" class="text-light"><small>Have An Account</small></a>
            </div>
          </div>
        </div>
      </div>
