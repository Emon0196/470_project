<?php
  ...
  //register car
		...
		if(isset($_POST['reg_car']))
		{
            ...
            $query="INSERT INTO car_list (car_cat_id, car_regno, car_name, car_price, car_type, car_features, exterior_img, rear_img, interior_img, front_img) VALUES (?,?,?,?,?,?,?,?,?,?)";
                ...
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data" >
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">Car Hiring Price Per Day (TK)</label>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="car_type" onChange="getCarCategoryId(this.value);" id="car_type" >
                                    ...
                                    <?php
                                        ...
                                        $ret="SELECT * FROM car_categories ORDER BY RAND() LIMIT 10 "; 
