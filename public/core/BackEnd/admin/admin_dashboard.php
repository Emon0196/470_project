                    ...
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Cars</h5>
                        <?php
                              ...
                              $result ="SELECT count(*) FROM car_list ";
                              $stmt = $mysqli->prepare($result);
                              $stmt->execute();
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <?php
                          ...
                          $result ="SELECT SUM(p_amt) FROM payments ";
                          $stmt = $mysqli->prepare($result);
                          $stmt->execute();
                    ...
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Hired Cars</h5>
                        <?php
                              ...
                              $result ="SELECT count(*) FROM car_list WHERE  car_status  = 'Hired' ";
                              $stmt = $mysqli->prepare($result);
                              $stmt->execute();
                    ...
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Car Types</h5>
                        <?php
                              ...
                              $result ="SELECT count(*) FROM car_categories ";
                              $stmt = $mysqli->prepare($result);
                              $stmt->execute();
          ...
          dataPoints: [
            { 
              y:
                <?php
                  //code for summing up number of hatch backs
                  $result ="SELECT count(*) FROM bookings WHERE car_type  = 'Hatchback' AND b_status ='Approved' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
                  $stmt->bind_result($hatchback);
                  $stmt->fetch();
            ...
            { y:
                <?php
                    //code for summing up number of Sedan | Saloon
                    $result ="SELECT count(*) FROM bookings WHERE car_type  = 'Sedan | Saloon' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
                    $stmt->bind_result($sedan);
                    $stmt->fetch();
            ...
            { y:
              <?php
                    //code for summing up number of Multi-Purpose Vehicle (MPV)
                    $result ="SELECT count(*) FROM bookings WHERE car_type  = 'Multi-Purpose Vehicle (MPV)' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
                    $stmt->bind_result($MPV);
                    $stmt->fetch();
            ...
            { y:
              <?php
                    //code for summing up number of Sports Utility Vehicle (SUV)
                    $result ="SELECT count(*) FROM bookings WHERE car_type  = 'Sports Utility Vehicle (SUV)' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
                    $stmt->bind_result($SUV);
                    $stmt->fetch();
            ...
            { y: 
              <?php
                    //code for summing up number of Crossover
                    $result ="SELECT count(*) FROM bookings WHERE car_type  = 'Crossover' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
                    $stmt->bind_result($Crossover);
                    $stmt->fetch();
            ...
            { y:
              <?php
                    //code for summing up number of Coupe
                    $result ="SELECT count(*) FROM bookings WHERE car_type  = 'Coupe' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
                    $stmt->bind_result($Coupe);
                    $stmt->fetch();
            ...
            { y:
              <?php
                    //code for summing up number of Convertible
                    $result ="SELECT count(*) FROM bookings WHERE car_type  = 'Convertible' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
                    $stmt->bind_result($Convertible);
                    $stmt->fetch();
