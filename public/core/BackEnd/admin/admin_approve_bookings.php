<?php
  ...
  {
        $id=intval($_GET['del_booking']);
        $ad="DELETE FROM  bookings WHERE b_id = ?";
                    ...
                    <!-- Projects table -->
                        <table class="table align-items-center table-flush">
                            ...
                            //get details of all cars
                                    $ret="SELECT * FROM bookings  ORDER BY RAND() "; 
                            ...
                            ?>
                                ...
                                <td>
                                    <?php 
                                        ...
                                        ?>  
                                    <a href  ='admin_approve_bookings.php?del_booking=<?php echo $row->b_id;?>' class='badge badge-danger'>
