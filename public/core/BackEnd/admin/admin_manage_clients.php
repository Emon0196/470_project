<?php
  ...
  if(isset($_GET['delete_id']))
  {
        ...
        $adn="DELETE FROM clients WHERE c_id = ?";
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <?php
                                //get details of recently joined clients
                                    $ret="SELECT * FROM clients ORDER BY RAND() LIMIT 10 "; 
                            ...
                            ?>
                                ...
                                <td>
                                        ...
                                        <a href  ="admin_update_client.php?c_id=<?php echo $row->c_id;?>&c_nnumber=<?php echo $row->c_number;?>" class="badge badge-primary">
